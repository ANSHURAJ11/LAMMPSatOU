...
First, to understand dislocations, I recommend these readings depending on how much you already know and how much more you want to know.
   ...
   D. Hull, D.J. Bacon, [Introduction of Dislocations](), 5th edition, 2011 [[PDF]()]
   Yu N Osetsky, D J Bacon, [An atomic-level model for studying the dynamics of edge dislocations in metals](), Modelling Simul. Mater. Sci. Eng. 11 (2003) 427
   Wu-Rong Jian, Min Zhang, Shuozhi Xu, Irene J. Beyerlein, [Atomistic simulations of dynamics of an edge dislocation and its interaction with a void in copper: A comparative study](),          Modelling Simul. Mater. Sci. Eng. 28 (2020) 045004
   Intermediate-level:

   D.J. Bacon, Y.N. Osetsky, D. Rodney, [Dislocation-obstacle interactions at the atomic level](), in Dislocations in Solids, 15 (2009) 1--90 [PDF]
   Jaehyun Cho, Till Junge, Jean-François Molinari, Guillaume Anciaux, [Toward a 3D coupled atomistic and discrete dislocation dynamics simulation: dislocation core structures and Peierls stresses with several character angles in FCC aluminum](), Adv. Model. Simul. Eng. Sci. 2 (2015) 12
   Vasily V. Bulatov, Wei Cai, [Computer Simulations of Dislocations](), 2006 [[PDF]()]
     Johannes Weertman, Julia R. Weertman, [Elementary Dislocation Theory](), 1992
   Advanced-level:

   Peter M. Anderson, John P. Hirth, Jens Lothe, [Theory of Dislocations](), 3rd edition, 2017
Some Google Drive links above are private. To have access, [email me]() and let me know the          email address associated with your Google Drive.
